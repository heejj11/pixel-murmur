...
const renderDirectory = resolve(
  "../campaigns/2026-09-pilot/PM-001/video/renders",
);
const temporaryDirectory = mkdtempSync(join(tmpdir(), "pm001-renders-"));
const renders = [
  { file: "pm-001_ig_12s_v01.mp4", duration: "12" },
  { file: "pm-001_ig_loop_06s_v01.mp4", duration: "6" },
];
...
console.log(`Finalized ${renders.length} PM-001 renders to exact durations.`);
