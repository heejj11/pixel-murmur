...
export const PM019Reel: React.FC = () => {
  return (
    <>
      <TransitionSeries>
        <TransitionSeries.Sequence durationInFrames={102} name="01 Action hook">
          <SceneAction />
        ...
        />
        <TransitionSeries.Sequence durationInFrames={84} name="02 Mechanism">
          <SceneMechanism />
        </TransitionSeries.Sequence>
        <TransitionSeries.Transition
          presentation={fade()}
          timing={linearTiming({ durationInFrames: 6 })}
        />
        <TransitionSeries.Sequence durationInFrames={96} name="03 Color vote">
          <SceneClosing />
        </TransitionSeries.Sequence>
      </TransitionSeries>
      <Audio
