...
const publicPhoneMemoDispenser = {
  ...
  accent: '#5f6548',
  href: '/objects/pm-014',
  alt: '올리브색 공중전화 형태의 본체와 전용 MEMO 버튼, 하단 메모 배출구를 결합한 디스펜서 렌더',
  category: 'Stationery Tool',
  variant: 'Mechanical Ratchet Feed',
  intro: 'A payphone-shaped desk dispenser that advances one preprinted memo from a compact paper roll whenever its dedicated MEMO button is pressed.',
  introKo: '전용 MEMO 버튼을 한 번 누를 때마다 작은 롤에서 미리 인쇄된 메모 한 장 길이를 내보내는 공중전화형 데스크 문구 콘셉트입니다.',
  statement: ['Press once.', 'Take one note.'],
  story: [
    'The message window, handset, metal coin plate, and keypad preserve the memory of a public phone, while one wide MEMO key performs the practical action. The numeric keys remain tactile visual references rather than pretending to control a printer.',
  ...
  notes: [
    ['Dedicated memo key', 'One wide key concentrates the operating force and avoids suggesting that every number triggers a different electronic function.'],
    ['Ratchet feed', 'A spring-return rack, one-way clutch, and silicone rollers translate one press into a repeatable 80–100 mm paper advance.'],
    ['Compact roll refill', 'A single 57 mm-wide roll with an outer diameter below roughly 55 mm slides onto the side axle behind a latched refill door.'],
  ...
  gallery: [
    ['hero', '01-hero.webp', '올리브색 공중전화 형태와 전용 MEMO 버튼, 한 장의 메모가 나온 하단 배출구를 보여주는 대표 렌더', 'Hero view'],
    ['press-and-feed', '02-press-and-feed.webp', '손가락으로 전용 MEMO 버튼을 눌러 하단에서 메모 한 장 길이를 내보내는 사용 렌더', 'Press and feed'],
    ['mechanical-cutaway', '03-mechanical-cutaway.webp', '내부의 메모 롤과 실리콘 급지 롤러, 래칫 기어, 스프링 구조를 보여주는 절개 렌더', 'Mechanical cutaway'],
    ['roll-refill', '04-roll-refill.webp', '측면 리필 도어를 열고 가로축에 57밀리미터 메모 롤 한 개를 끼우는 렌더', 'Roll refill'],
    ['tear-off-detail', '05-tear-off-detail.webp', '보호 턱 안쪽의 미세 톱니 절취선으로 메모 한 장을 손으로 떼는 디테일 렌더', 'Tear-off detail'],
    ['memo-refills', '06-memo-refills.webp', '크림, 세이지, 블루, 핑크 색상의 줄 메모와 체크, 도트, 무지 리필 롤 구성 렌더', 'Memo refill set'],
    ['variant-lineup', '07-color-lineup.webp', '올리브, 크림 베이지, 브릭 레드, 차콜 색상의 공중전화 메모 디스펜서 네 가지 렌더', 'Color lineup'],
    ['worn-lifestyle', '08-everyday-use.webp', '플래너와 펜이 놓인 책상에서 메모를 한 장 떼어 사용하는 일상 장면', 'Everyday use'],
    ['packaging', '09-packaging.webp', '공중전화 메모 디스펜서와 리필 롤, 금속 토큰, 설명서, 성형 펄프 트레이로 구성한 패키지 렌더', 'Packaging concept'],
  ].map(([role, file, alt, label]) => ({
    role,
